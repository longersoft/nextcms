<?php
require_once 'CronExpression/FieldFactory.php';
 ...
 */
class CronExpression_CronExpression
{
	const MINUTE = 0;
	const HOUR = 1;
	const DAY = 2;
	 ...
	 * @param CronExpression_FieldFactory $fieldFactory (optional) Field factory to use with
	 *      the expression.  Leave NULL to use the default factory.
	 *
	 * @return CronExpression_CronExpression
	 */
