 ...
 * NextCMS
 * 
 * @author		Akeem Philbert
 * @link		http://nextcms.org
 * @category	modules
 * @package		core
 * @subpackage	base
 * @see			http://ak33m.com/?p=71
 * @since		1.0
 * @version		2011-10-18
 */
...
class Core_Base_OpenId_Extension_Ax extends Zend_OpenId_Extension
{
	/**
	 ...
	 * @see Zend_OpenId_Extension::prepareRequest()
	 * @return bool
	 */
	 ...
	 *
	 * @param array $params request's var/val pairs
	 * @see Zend_OpenId_Extension::parseRequest()
	 * @return bool
	 */
	 ...
	 * @see Zend_OpenId_Extension::prepareResponse()
	 * @return bool
	 */
	 ...
	 *
	 * @param array $params response's var/val pairs
	 * @see Zend_OpenId_Extension::parseResponse()
	 * @return bool
	 */
	 ...
	 * @see Zend_OpenId_Extension::getTrustData()
	 * @return bool
	 */
	 ...
	 * @see Zend_OpenId_Extension::checkTrustData()
	 * @return bool
	 */
