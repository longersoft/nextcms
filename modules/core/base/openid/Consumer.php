...
class Core_Base_OpenId_Consumer extends Zend_OpenId_Consumer
{
	/**
	 * @see Zend_OpenId_Consumer::_discovery()
	 * @return bool
	...
	protected function _discovery(&$id, &$server, &$version)
	{
		...
		/** Supports Google Profile */
		else if (preg_match('/profiles.google.com\/profiles\/(\w+)/i', $id, $r)) {
			$version = 2.0;
	...
	/**
	 * @see Zend_OpenId_Consumer::_checkId()
	 * @return bool
	 */
