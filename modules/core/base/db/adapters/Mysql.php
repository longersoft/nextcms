...
class Core_Base_Db_Adapters_Mysql extends Zend_Db_Adapter_Abstract
{
	/**
	 ...
	 * @var string
	 */
	protected $_defaultStmtClass = 'Core_Base_Db_Adapters_Statement_Mysql';
	...
	public function getServerVersion()
	{
		...
		$pos = strpos($version, ':');
		$version = substr($version, $pos, strlen($version));
		return $version;
	}
}
